...
{
    return wallet->GetBalance() - wallet->GetUnconfirmedBalance();
}
...
void WalletModel::checkBalanceChanged()
{
    ...
    //printf("get balance done\n");
    qint64 newUnconfirmedBalance = getUnconfirmedBalance();
    //printf("get unconfirmed done\n");
    qint64 newImmatureBalance = 0;
	...
	//printf("emitting balance changed\n");
...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl *coinControl)
{
    ...
    std::map<CKeyID, int64_t>  mapSend;
...

    {
        ...
        bool fCreated = wallet->CreateTransaction(mapSend, *newTx, nFeeRequired, strFailReason);
...
static void ShowProgressF(WalletModel *walletmodel, const std::string &title, int nProgress)
{
